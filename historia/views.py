...
FRASES_THIAGO = [
    {'texto': 'Já não consigo imaginar minha vida sem você', 'autor': 'Thiago'},
    {'texto': 'Me sinto o homem mais feliz do mundo por ter te reencontrado e finalmente achar alguém que me completa 💙', 'autor': 'Thiago'},
    {'texto': 'Obrigado por nunca desistir de mim, mesmo eu sendo um cabeça...', 'autor': 'Thiago'},
    {'texto': 'Agradeço todo dia por nossos caminhos terem se cruzado 🥰✨', 'autor': 'Thiago'},
    {'texto': 'Tô vivendo e sentindo coisas que achei que nem eram mais possíveis', 'autor': 'Thiago'},
    {'texto': 'Obrigado por tudo tudo, por ter entrado na minha vida dessa forma tão linda e intensa que só você sabe, você é mais do que Luz na minha vida mozão.', 'autor': 'Thiago'},
    {'texto': 'Ia te fazer uma massagem, ficar grudadinho falando o quanto eu te amo e o quanto eu quero viver com você até o último dia da minha vida.', 'autor': 'Thiago'},
    {'texto': 'Não paro de pensar em você 1 minuto desde quando te reencontrei.', 'autor': 'Thiago'},
    {'texto': 'Que seja de emoção e felicidade, pq é só o que eu tenho de vc, passo o dia todo pensando em vc e quando não to pensando to com vc.', 'autor': 'Thiago'},
    {'texto': 'Não precisa agradecer, eu também, to vivendo e sentindo coisas que achei que nem eram mais possíveis, te amo muito, mas muito mesmo, nunca se esqueça disso, tá?', 'autor': 'Thiago'},
    {'texto': 'Só me fez ver ainda mais o quanto sou apaixonado pela vida e obviamente, o mais importante, loucamente apaixonado por você.', 'autor': 'Thiago'},
    {'texto': 'Eu sou completamente louco por você minha vida, não paro de pensar em você 1 minuto desde quando te reencontrei.', 'autor': 'Thiago'},
    {'texto': 'Seria um sonho, estar na mesma casinha que vc, tudo cheirosinho que a gente fez compra e limpou a casa.', 'autor': 'Thiago'},
    {'texto': 'Parece que não importa o que eu falo você não entende, eu só quero você e apenas você e nada que aconteça vai me fazer mudar a cabeça ou te largar.', 'autor': 'Thiago'},
    {'texto': 'O que eu mais quero é arrumar um emprego logo, juntar dinheiro e morar com você pra chegar todo dia do trabalho e te ver linda e maravilhosa como és. 💕', 'autor': 'Thiago'},
]

FRASES_MEL = [
    {'texto': 'De verdade nunca vivi o que vivo com você!', 'autor': 'Mel'},
    {'texto': 'Eu nunca imaginei que estaríamos cogitando morar juntos e construir nossa família 🥹', 'autor': 'Mel'},
    {'texto': 'Eu te amo tanto rapaz… que já até chorei hoje por isso 💛🥹', 'autor': 'Mel'},
    {'texto': 'Só você pra animar meus dias — obrigada por cuidar de mim', 'autor': 'Mel'},
    {'texto': 'Obrigada por tudo que faz por mim e por nós — sempre, sempre 🥹💛', 'autor': 'Mel'},
    {'texto': 'Me dói imaginar minha vida sem você… depois de você eu nunca mais vou querer amar outro alguém!', 'autor': 'Mel'},
    {'texto': "O que é meu também será teu mocinho, depois que eu responder 'Sim' toda de branco na cachoeira. 💍", 'autor': 'Mel'},
    {'texto': 'Eu só quero te fazer feliz todos os dias das nossas vidas, te ver conquistar o mundo todo e ao seu lado construir nossa vida juntos.', 'autor': 'Mel'},
    {'texto': 'Não vejo a hora de construir a vida contigo amor… tenho tantos tantos tantos planos pro nosso futuro.', 'autor': 'Mel'},
    {'texto': 'É ruim chegar em casa e não ter seu cheiro, deitar sozinha e saber que não vai ter você aqui pra me dar beijinhos toda hora.', 'autor': 'Mel'},
    {'texto': 'Eu quero muito, quero muito ser tua mulher e viver esse sonho todo dia!', 'autor': 'Mel'},
    {'texto': 'Você é o homem dos meus sonhos.', 'autor': 'Mel'},
    {'texto': 'Falei pra sua sogra que você é perfeito e que tenho sonho de construir família com você.', 'autor': 'Mel'},
    {'texto': 'Eu esperei tanto tanto tanto mais tanto tempo pela sua chegada meu amor.', 'autor': 'Mel'},
    {'texto': 'Dois anos sendo muito feliz ao lado do cara maaaaaais amoroso do mundo.', 'autor': 'Mel'},
]
